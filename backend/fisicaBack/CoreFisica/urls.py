...
from .views.asignacion_views import obtener_asignaciones, asignar_servicio, editar_servicio, guardar_orden_asignacion, guardar_orden_sacafranco, eliminar_asignacion, exportar_asignaciones_excel, exportar_asignaciones_reimportable, sacafranco_filas, eliminar_sacafranco_fila, asignaciones_vacantes, personas_asignadas, sacafranco_personas_mes, puestos_ocupacion, eventual_datos, eventuales_lista, asignacion_de_persona, historial_asignaciones_mes
